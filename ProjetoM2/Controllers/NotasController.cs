...
namespace ProjetoM2.Controllers
{
    public class NotasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,M1,M2,SUB,Previsao,Media")] Notas notas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,M1,M2,SUB,Previsao,Media")] Notas notas)
        {
            if (ModelState.IsValid)
            {
